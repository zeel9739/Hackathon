  ...
  return (
    ...
    >
      ...
      <div className="d-flex justify-content-between mt-3 p-2 flex-wrap" >
        <div className="ms-4 d-flex" style={{ display:'flex'}}> 
          <Leftbar />
          <NavLink
            to='/'
            style={{
        ...
        <div className={classes.serchData}>
          <div className={classes.search}>
            <div className="d-flex align-items-center" style={{width: "510px"}}>
            ...
            <span style={{width:"510px"}}>
          {console.log(suggestions.length,'suggestions')}
           {suggestions.length <= 0 && text.length > 0  ?<div>Not Match</div>  :
